...
class Dashboard implements HttpServerInterface
{
    /**
    ...
    public function onOpen(ConnectionInterface $conn, RequestInterface $request = null)
    {
        ...
        $loader = new \Twig_Loader_Filesystem('/home/marc/Projects/phry/assets/templates');
        $twig = new \Twig_Environment($loader, array(
        ));
        $buffer = $twig->render('index.html.twig');
        $conn->send($buffer);
        $conn->close();
    }
